...
class xiaomi():
    ...
    def shuchu(self,date):
        ...
        for page in range(1, 2):
            ...
            writer = pd.ExcelWriter(r'安卓商店\小米商店.xlsx')
            # 将df1与df2写入writer中
        ...
        for page in range(1, 2):
            ...
            # 将df1与df2写入writer中
            df2.to_excel(writer, sheet_name='影音视听', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df3.to_excel(writer, sheet_name='实用工具', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df4.to_excel(writer, sheet_name='聊天社交', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df5.to_excel(writer, sheet_name='图书阅读', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df6.to_excel(writer, sheet_name='时尚购物', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df7.to_excel(writer, sheet_name='摄影摄像', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df8.to_excel(writer, sheet_name='学习教育', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df9.to_excel(writer, sheet_name='旅行交通', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df10.to_excel(writer, sheet_name='金融理财', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df11.to_excel(writer, sheet_name='娱乐消遣', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df12.to_excel(writer, sheet_name='新闻资讯', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df13.to_excel(writer, sheet_name='居家生活', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df14.to_excel(writer, sheet_name='体育运动', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df15.to_excel(writer, sheet_name='医疗健康', index=False, encoding='utf-8')
        ...
        for page in range(1, 2):
            ...
            #writer = pd.ExcelWriter('xiaomi.xlsx')
            # 将df1与df2写入writer中
            df16.to_excel(writer, sheet_name='效率办公', index=False, encoding='utf-8')
